...
- (id)copyWithZone:(NSZone *)zone
{
	...
	[newRequest setHandleAuthenticationChallengeInternally:[self handleAuthenticationChallengeInternally]];
	[newRequest setStreamProperties:[[[self streamProperties] copyWithZone:zone] autorelease]];
	return newRequest;
}
